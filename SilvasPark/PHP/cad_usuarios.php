...
$sql = "INSERT INTO silvas_park.tb_usuarios (NOME_COMP, USUARIO, EMAIL, SENHA) VALUES ('$nome_comp', '$nome_usu', '$email', '$senha')";
...
$consulta = "SELECT NOME_COMP, USUARIO, EMAIL, SENHA FROM silvas_park.tb_usuarios";
